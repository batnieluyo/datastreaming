...
class MyEvaluation extends BaseEvaluation
{
     ...
     */
    public string $description = 'Description for My.';

    /**
     * Path to the CSV file for this evaluation.
     * This path should be relative to the Laravel project's base_path().
     * Example: 'evaluations/data/my.csv'
     */
    public string $csvPath = 'app/Evaluations/data/my.csv';
    ...
    public function preparePrompt(array $csvRowData): string
    {
        if (!isset($csvRowData[$this->promptCsvColumn])) {
            throw new InvalidArgumentException(
                "CSV row for evaluation 'My' must contain a '" . $this->promptCsvColumn . "' column/key."
            );
        }
